...
SECRET_KEY = 'django-insecure-cues&^h5r23x#00$fnv-md74m=&f3!3b%n+b7ev!@$8ddhl09('
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'chapters.context_processors.chapter_menu',
            ],
        },
    },
]

WSGI_APPLICATION = 'my_story.wsgi.application'
